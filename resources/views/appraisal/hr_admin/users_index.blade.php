...
@section('content')
    <div class="card card-responsive">
        ...
        <div class="card-body" id="users-container" data-auto-refresh="true"
            data-refresh-url="{{ route('hr_admin.users_index') }}" data-refresh-target="#users-container">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-outline-secondary"
                                        href="{{ route('users.edit', $u) }}">Edit</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
